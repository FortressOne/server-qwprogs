...
New features
------
* `localinfo allowpracspawns 1` allows players to set a personal spawnpoint to practice. Players can then use commands `placepracspawn` and `removepracspawn`. Suicide penalties are removed while allowpracspawns is enabled. 
