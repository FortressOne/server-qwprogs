...
New features
------
* `localinfo allowpracspawns 1` allows clients to set a personal spawn point to practice various things (ie. cuss jumps). Clients can then use commands `placepracspawn` and `removepracspawn`. Suicide timers are disabled while allowpracspawns is enabled. 
